...
const MAX_GUESSES = 6;
const ALLOWED_LETTERS = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm',
    'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
const WORD_BANK = ['stars', 'earth', 'pluto', 'venus', 'astro', 'cosmo', 'rings', 'space', 
    'world', 'alien', 'night', 'cloud', 'plant', 'giant'];
...
function generateKeyboard() {
    ...
    deleteCell.classList.add('cell', 'wide-cell');
    ...
    submitCell.classList.add('cell', 'wide-cell');
...
function updateCurrentGuess(letter) {
    if (currentGuess.length < LENGTH_OF_WORD) currentGuess += letter;
